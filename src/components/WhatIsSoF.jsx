...
const WhatIsSoF = () => {
 ...
 We're not just a college; we're an innovation hub. Strong academics meet industry-powered curriculum, equipping you for careers that don't even exist yet.
 </p>
 </motion.div>
