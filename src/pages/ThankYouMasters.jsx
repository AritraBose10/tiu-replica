...
// Thank-you page dedicated to the postgraduate working-professionals lead
// form (MBA/M.Tech/M.Sc/Ph.D) — kept separate from the shared /thank-you
// page so the "Submit lead form (Masters)" Google Ads conversion fires
// exactly once per real Masters lead, with no risk of it firing for other
// forms on the shared page.
const ThankYouMasters = () => {
  useEffect(() => {
    ...
    // 2. Base config & conversion events
    ...
    inlineScript.text = `
      ...
      // Submit lead form (Masters) conversion event (AW-18134909671)
  ...
  return (
    <div className="min-h-screen bg-[#020205] relative overflow-hidden flex flex-col items-center justify-center px-4">
      <SEO
        title="Thank You | MBA, M.Tech, M.Sc & Ph.D for Working Professionals"
        description="Thank you for applying to a postgraduate programme for working professionals at Techno India University. Our admissions team will get back to you shortly."
        noindex={true}
      />
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center">
        ...
        >
          We've received your enquiry for our MBA, M.Tech, M.Sc or Ph.D programme for working professionals. Our admissions team will call you within <span className="text-white font-semibold">24 hours</span> to walk you through eligibility and next steps.
        </motion.p>
        ...
        >
          ...
          <a
            href="https://wa.me/918100203639?text=Hi%2C%20I%20just%20submitted%20an%20enquiry%20about%20MBA%2FM.Tech%2FM.Sc%2FPhD%20for%20working%20professionals"
            target="_blank"
        ...
        >
          <Link
            to="/pg-programs-for-professionals"
...
export default ThankYouMasters;
